...
const STORAGE_KEY = "fifteenPuzzleLastScore";

// ----------------------------
// 1. Save last round score locally
// ----------------------------
export function saveLocalPuzzleScore(score) {
...
// ----------------------------
export function loadLocalPuzzleScore() {
  try {
...
// ----------------------------
export async function savePuzzleScoreToBackend(points) {
  try {
    ...
    console.error("savePuzzleScoreToBackend error:", err);
    throw err;
  }
}
